...
<h3 align="center"> <b> Οδηγίες Εκτέλεσης </b> </h3>
 ...
 <p><b> 3.</b> Αποθηκεύουμε με όνομα Program.cs και κάνουμε compile το προγραμμά μας με την εντολή <b> csc Program.cs </b> εφόσον σιγουρευτούμε ότι είμαστε στο path με το αρχείο του κώδικα. </p>
 <p><b>4.</b> Άν δεν υπάρξει κάποιο μήνυμα προβλήματος με την εντολή μεταγλώτισης <b> csc Program.cs </b> εκτελούμε το πρόγραμμα με <b> ./Program.exe</b> .  </p>
